...
window.LITTLEQAIROES-PROJECT = window.LITTLEQAIROES-PROJECT || {};

LITTLEQAIROES-PROJECT.Analytics = LITTLEQAIROES-PROJECT.Analytics || (function (exports) {
    'use strict';
    ...
    Analytics.prototype.initTrackerReadyState = function () {
      this.readyState_ = LITTLEQAIROES-PROJECT.Deferred.createDeferred();
