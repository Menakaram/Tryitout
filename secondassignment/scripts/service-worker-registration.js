...
LITTLEQAIROES-PROJECT.ServiceWorkerRegistration = (function () {
  'use strict';
    ...
    if (!isAlreadyRegistered) {
      ...
      if ('serviceWorker' in navigator) {
        navigator.serviceWorker.register(URL, {
          ...
          LITTLEQAIROES-PROJECT.Analytics.trackError('navigator.serviceWorker.register() error', e);
  ...
  if (navigator.serviceWorker && navigator.serviceWorker.controller) {
    navigator.serviceWorker.controller.onstatechange = function (event) {
      if (event.target.state === 'redundant') {
        ...
        if (LITTLEQAIROES-PROJECT.Elements && LITTLEQAIROES-PROJECT.Elements.Template &&
          LITTLEQAIROES-PROJECT.Elements.Template.$.toast.show) {
          LITTLEQAIROES-PROJECT.Elements.Template.$.toast.show(
